...
/* package TidalGuiot-0.1.0.0 */
#define VERSION_TidalGuiot "0.1.0.0"
#define MIN_VERSION_TidalGuiot(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "TidalGuiot-0.1.0.0-B3BpTxufbTc2CeTxoGfx0N"

#define CURRENT_PACKAGE_KEY "TidalGuiot-0.1.0.0-B3BpTxufbTc2CeTxoGfx0N"
